        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-6 order-1 lg:order-2 flex justify-center lg:justify-end relative">
               <div className="relative w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px] -mt-4 sm:-mt-6 lg:-mt-8">
            ...
            <div className="flex gap-6 group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div>
                <p className="text-sm leading-relaxed text-stone-700">
                  Адвокатское бюро было основано в 2021 году двумя адвокатами: Муратовой Надеждой Дмитриевной и Муратовой Надеждой Георгиевной. В последствии, в число партнеров бюро вошли еще пять адвокатов. В настоящее время в бюро работают шесть адвокатов-партнеров.
                </p>
              </div>
            </div>
